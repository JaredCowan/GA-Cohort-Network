class HooksController < ApplicationController
  ...
  def post_callback
    ...
    if action == "opened"
      ...
      post = HTTParty.post("https://api.github.com/repos/JaredCowan/Ga-Cohort-Network/issues/1/comments", :headers => { "User-Agent" => usr[:username], "Authorization" => ENV['GH_TOKEN'] }, :body => { :body => final}.to_json) 
    end
