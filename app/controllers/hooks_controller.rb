class HooksController < ApplicationController
  ...
  def post_callback
    ...
    if $bot != "VerdeCircle-Bot"
      ...
      post = HTTParty.post("https://api.github.com/repos/JaredCowan/Ga-Cohort-Network/issues/1/comments", :headers => { "User-Agent" => "VerdeCircle-Bot", "Authorization" => "token 809094b8331d415d955bb191f0dae93ab13c10ec" }, :body => { :body => "#{final}"}.to_json)
